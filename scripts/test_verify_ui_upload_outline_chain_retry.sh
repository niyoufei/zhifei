...
UI_ERROR=BrowserType.launch: Target page, context or browser has been closed | signal=SIGKILL
TEXT
  exit 0
fi
...
echo "[PASS] verify_ui_upload_outline_chain retry regression checks passed"
