...
REQUIRED_DOCX_ISOLATION_GUARD_FIELDS = frozenset(
    {
        "contract_version",
...
DOCX_ISOLATION_STATUSES = frozenset(
    {
        "not_created",
        "blocked",
...
CURRENT_STAGE_EMITTABLE_DOCX_ISOLATION_STATUSES = frozenset(
    {
        "not_created",
        "blocked",
        "stale_source_hash",
...
DOCX_EXPORT_DECISIONS = frozenset(
    {
        "none",
        "block",
        "isolate_shadow_only",
...
DOCX_EXPORT_REQUEST_STATUSES = frozenset(
    {
        "not_requested",
        "requested_blocked",
        "route_blocked",
...
def build_docx_isolation_guard(
    *,
    ...
    docx_export_decision: str = "none",
    docx_export_scope: str = "metadata_only",
    docx_export_mode: str = "disabled_current_stage",
    docx_target_type: str = "metadata_only",
    docx_export_request_status: str = "not_requested",
    docx_export_requested: bool = False,
    docx_export_route: str = "",
    docx_export_payload_hash: str = "",
    docx_candidate_hash: str = "",
    docx_source_snapshot_hash: str = "",
    ...
    docx_export_decision = _text(docx_export_decision, limit=120)
    docx_export_scope = _text(docx_export_scope, limit=120)
    docx_export_mode = _text(docx_export_mode, limit=120)
    docx_target_type = _text(docx_target_type, limit=120)
    docx_export_request_status = _text(docx_export_request_status, limit=120)
    docx_export_route = _text(docx_export_route, limit=240)
    docx_export_payload_hash = _text(docx_export_payload_hash, limit=240)
    docx_candidate_hash = _text(docx_candidate_hash, limit=240)
    docx_source_snapshot_hash = _text(docx_source_snapshot_hash, limit=240)
    ...
    requested_status = _text(docx_isolation_status, limit=120)
    ...
    enum_checks = (
        (requested_status, DOCX_ISOLATION_STATUSES, "invalid_docx_isolation_status"),
    ...
    if response_mode == "thinking_only_fallback":
        _append_unique(blocked_reasons, "thinking_only_fallback_not_docx_export_capable")
    ...
    if docx_export_request_status in request_status_blocks:
        _append_unique(blocked_reasons, request_status_blocks[docx_export_request_status])

    if docx_export_requested:
        _append_unique(blocked_reasons, "docx_export_request_blocked")
    if docx_export_route == "/export_docx":
        _append_unique(blocked_reasons, "docx_export_route_blocked")
    if not docx_export_payload_hash:
        _append_unique(blocked_reasons, "docx_export_payload_blocked")

    required_hashes = {
        "docx_candidate_hash": docx_candidate_hash,
        "docx_source_snapshot_hash": docx_source_snapshot_hash,
    ...
    if requested_status == "isolated_shadow_only" or docx_export_decision == "isolate_shadow_only":
        _append_unique(blocked_reasons, "docx_isolation_is_not_export_permission")

    _append_unique(blocked_reasons, "real_docx_isolation_not_implemented_current_stage")
    ...
    docx_guard_seed = {
        ...
        "docx_export_payload_hash": docx_export_payload_hash,
        "docx_candidate_hash": docx_candidate_hash,
        "docx_source_snapshot_hash": docx_source_snapshot_hash,
        "writeback_candidate_hash": writeback_candidate_hash,
        "source_snapshot_hash": source_snapshot_hash,
    ...
    if not docx_isolation_guard_id:
        docx_isolation_guard_id = _docx_isolation_guard_id(docx_guard_seed)
    ...
    return {
        ...
        "source_hash_guard_id": source_hash_guard_id,
        "review_apply_guard_id": review_apply_guard_id,
        "docx_isolation_status": status,
        "docx_export_decision": docx_export_decision,
        "docx_export_scope": docx_export_scope,
        "docx_export_mode": docx_export_mode,
        "docx_target_type": docx_target_type,
        "docx_export_request_status": docx_export_request_status,
        "docx_export_requested": docx_export_requested,
        "docx_export_route": docx_export_route,
        "docx_export_payload_hash": docx_export_payload_hash,
        "docx_candidate_hash": docx_candidate_hash,
        "docx_source_snapshot_hash": docx_source_snapshot_hash,
        "writeback_candidate_hash": writeback_candidate_hash,
